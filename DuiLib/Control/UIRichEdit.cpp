...
#include <textserv.h>
    ...
    void CRichEditUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
    {
        if (_tcscmp(pstrName, _T("vscrollbar")) == 0)
        {
            ...
            if (m_pTwh)
                m_pTwh->TxEnableScrollBar(SB_VERT, ESB_ENABLE_BOTH);
        }
        if (_tcscmp(pstrName, _T("autovscroll")) == 0)
        {
            ...
            if (m_pTwh)
                m_pTwh->TxShowScrollBar(SB_VERT, true);
        }
        else if (_tcscmp(pstrName, _T("hscrollbar")) == 0)
        {
            ...
            if (m_pTwh)
                m_pTwh->TxEnableScrollBar(SB_HORZ, ESB_ENABLE_BOTH);
        }
        if (_tcscmp(pstrName, _T("autohscroll")) == 0)
        {
            ...
            if (m_pTwh)
                m_pTwh->TxShowScrollBar(SB_HORZ, true);
        }
