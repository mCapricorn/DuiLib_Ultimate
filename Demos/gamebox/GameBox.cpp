...
public:
	void InitWindow()
	{
		...
		CGameListUI::Node* pCategoryNode1 = AddCategoryNode(_T("����һ"), 1);
		CGameListUI::Node* pCategoryNode2 = AddCategoryNode(_T("�����"), 1);
		CGameListUI::Node* pCategoryNode3 = AddCategoryNode(_T("������"), 1);
		CGameListUI::Node* pCategoryNode4 = AddCategoryNode(_T("������"), 1);

		for( int i = 0; i < 6; ++i )
		{
			AddGameNode(_T("������Ϸ"), pCategoryNode1, i);
			AddGameNode(_T("������Ϸ"), pCategoryNode2, i);
			AddGameNode(_T("������Ϸ"), pCategoryNode3, i);
			AddGameNode(_T("������Ϸ"), pCategoryNode4, i);
		}
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPSTR /*lpCmdLine*/, int nCmdShow)
{
	...
	pFrame->Create(NULL, _T("��Ϸ����"), UI_WNDSTYLE_FRAME, 0L, 0, 0, 800, 572);
	pFrame->CenterWindow();
